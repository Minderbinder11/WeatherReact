            ...
            <div className="top-bar">
                <div className="top-bar-left">
                    <ul className="menu">
                        ...
                        <li><IndexLink to="/examples" activeClassName="active" activeStyle={{fontWeight: 'bold'}}>Examples</IndexLink>
                        </li>
                        <li><IndexLink to="/fiveday" activeClassName="active" activeStyle={{fontWeight: 'bold'}}>Five
                            Day Forecast</IndexLink></li>
                    </ul>
                </div>
